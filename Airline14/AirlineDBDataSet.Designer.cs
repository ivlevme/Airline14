...
namespace Airline14.AirlineDBDataSetTableAdapters {
...
SELECT ID, Login, Password, Role FROM Users WHERE (ID = @ID)";
        ...
        public virtual int Fill(AirlineDBDataSet.UsersDataTable dataTable) {
        ...
        public virtual AirlineDBDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AirlineDBDataSet.UsersDataTable dataTable = new AirlineDBDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AirlineDBDataSet.UsersDataTable dataTable) {
